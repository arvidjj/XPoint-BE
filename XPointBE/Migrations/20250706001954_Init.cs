...
namespace XPointBE.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreatedAt", "CreatedBy", "Email", "EmailConfirmed", "FechaRegistro", "LockoutEnabled", "LockoutEnd", "Nombre", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "Telefono", "TwoFactorEnabled", "UltimaConexion", "UpdatedAt", "UpdatedBy", "UserName" },
                values: new object[] { "admin-user-id", 0, "SEEDING-ADMIN-USER-CONCURRENCY-STAMP", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@gmail.com", true, new DateTime(2025, 7, 6, 0, 19, 54, 12, DateTimeKind.Utc).AddTicks(9494), false, null, "admin", "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEDhY8hUYe9ML7KRWEgirJnVe8yyUBpMPPWunGjzagL5+fV3uq07abey++XHSHIUKgQ==", null, false, "SEEDING-ADMIN-USER-SECURITY-STAMP", null, false, null, null, null, null });
